...
export default function DeleteUserProfileForm() {
  ...
  return (
    <div className="max-w-md mx-auto bg-white p-6 rounded-xl shadow-md border border-gray-200">
      <h2 className="text-2xl font-bold text-gray-900 mb-4 text-center">Eliminar Cuenta</h2>
      <p className="mb-4 text-gray-700">
        ¿Estás seguro de que deseas eliminar tu cuenta? Esta acción eliminará toda tu información, incluidos tus reportes.
      </p>
      <p className="mb-4 text-gray-700">
